...
class ShoppingCartProviderHome extends StatefulWidget {
  ...
  @override
  State<ShoppingCartProviderHome> createState() => _ShoppingCartProviderHomeState();
}
    ...
    return Scaffold(
      ...
      body: ListView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          if (index == 0)
            return HeaderTile(title: '총 가격 : ${(context.watch<ShoppingCart>().count)*1000} 원', subtitle: '총 ${context.read<ShoppingCart>().count} 개');
          return ShoppingListTile(
            title: '${context.watch<ShoppingCart>().products.elementAt(index-1)}',
            subtitle: '가격 : 1,000원', item: context.watch<ShoppingCart>().products.elementAt(index-1),
          );
        },
      ),
